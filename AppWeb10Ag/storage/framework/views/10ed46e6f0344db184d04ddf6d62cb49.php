        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('buscarus')); ?>" class="row g-3">
                            <?php echo csrf_field(); ?>
                            <div class="col-md-4">
            ...
            <div class="col-md-3">
                <div class="card bg-success text-white border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h4 class="card-title"><?php echo e($datos->where('roles', 'Administrador')->count()); ?></h4>
            ...
            <div class="col-md-3">
                <div class="card bg-warning text-white border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h4 class="card-title"><?php echo e($datos->where('roles', 'Profesor')->count()); ?></h4>
            ...
            <div class="col-md-3">
                <div class="card bg-info text-white border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h4 class="card-title"><?php echo e($datos->where('roles', 'Estudiante')->count()); ?></h4>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <img src="<?php echo e($dato['imgprofile']); ?>" alt="Avatar" 
                                         class="rounded-circle" style="width: 40px; height: 40px; object-fit: cover;"
                                         onerror="this.src='<?php echo e(asset('img/default-avatar.png')); ?>'">
                                </td>
                                <td>
                                    <div class="fw-bold"><?php echo e($dato['nombre_apellido']); ?></div>
                                    <small class="text-muted"><?php echo e($dato['address'] ?: 'Sin dirección'); ?></small>
                                </td>
                                <td>
                                    <span class="badge bg-light text-dark"><?php echo e($dato['usuario']); ?></span>
                                </td>
                                <td>
                                    <a href="mailto:<?php echo e($dato['correo']); ?>" class="text-decoration-none">
                                        <i class="fas fa-envelope me-1"></i><?php echo e($dato['correo']); ?>

                                    </a>
                                </td>
                                <td>
                                    <?php if($dato['roles'] == 'Administrador'): ?>
                                        <span class="badge bg-danger"><?php echo e($dato['roles']); ?></span>
                                    <?php elseif($dato['roles'] == 'Profesor'): ?>
                                        <span class="badge bg-warning text-dark"><?php echo e($dato['roles']); ?></span>
                                    <?php else: ?>
                                        <span class="badge bg-info"><?php echo e($dato['roles']); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <code><?php echo e($dato['dni'] ?: 'Sin cédula'); ?></code>
                                </td>
                                <td>
                                    <?php if($dato['phones']): ?>
                                        <a href="tel:<?php echo e($dato['phones']); ?>" class="text-decoration-none">
                                            <i class="fas fa-phone me-1"></i><?php echo e($dato['phones']); ?>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        <a href="<?php echo e(route('usuarios.edit', $dato['id'])); ?>" 
                                        ...
                                        <button type="button" 
                                                ...
                                                onclick="verDetalles(<?php echo e($dato['id']); ?>)"
                                                title="Ver detalles">
                                            <i class="bi bi-eye-fill"></i>
                                        </button>
                                        <form class="d-inline deleteForm" 
                                              action="<?php echo e(route('usuarios.destroy', $dato['id'])); ?>" 
                                              method="POST">
                                            <?php echo csrf_field(); ?>
            ...
            <div class="card-footer bg-white border-0">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="text-muted">
                        ...
                        de <?php echo e($datos->total()); ?> usuarios
                    </div>
                    <div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Isate_proyect\Proyectos_practicas_studiantes\Sistema_asistencia\resources\views/usuarios/index.blade.php ENDPATH**/ ?>