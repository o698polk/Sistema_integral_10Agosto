...
<table class="table boder_bar btn_modulos">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo e($dato['roles']); ?></td>
      <td><?php echo e($dato['dni']); ?></td>
      <td><?php echo e($dato['phones']); ?></td>
      <td><?php echo e($dato['address']); ?></td>
      <td><?php echo e($dato['account']); ?></td>
      <td> <img src="<?php echo e($dato['imgprofile']); ?>" alt="avatar"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Sistema_de_Ventas_Laravel\resources\views/usuarios/index.blade.php ENDPATH**/ ?>