...
<?php $__env->startSection('title', 'REGISTRO - COLEGIO 10 DE AGOSTO'); ?>
...
<div class="register-container">
    <div class="register-card">
        <div class="school-logo">
            <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Logo Colegio" style="width: 60px; height: 60px; filter: brightness(0) invert(1); border-radius: 100%;">
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Isate_proyect\Proyectos_practicas_studiantes\Sistema_asistencia\resources\views/extens/register.blade.php ENDPATH**/ ?>