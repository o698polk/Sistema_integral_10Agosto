            ...
            <div class="col-lg-8">
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-body p-5">
                        ...
                        <form method="POST" action="<?php echo e(route('usuarios.store')); ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-floating">
                                        <input type="text" name="nombre_apellido" id="nombre_apellido" 
                                               class="form-control <?php $__errorArgs = ['nombre_apellido'];
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="file" name="imgprofile" id="imgprofile" 
                                               class="form-control <?php $__errorArgs = ['imgprofile'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex flex-wrap gap-2 justify-content-center">
                                        ...
                                        <a href="<?php echo e(route('usuarios.index')); ?>" class="btn btn-secondary btn-lg">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Isate_proyect\Proyectos_practicas_studiantes\Sistema_asistencia\resources\views/usuarios/create.blade.php ENDPATH**/ ?>