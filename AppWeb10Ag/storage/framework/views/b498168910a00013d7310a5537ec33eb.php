...
<center>
    ...
    <section id="menu" class="menu">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <form method="POST"  action="<?php echo e(route('buscarproductohome')); ?>" >
    <?php echo csrf_field(); ?>
          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <?php $__currentLoopData = $datos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <div class="col-lg-4 menu-item">
                <a href=" <?php echo e($dato['imgproduct']); ?>" class="glightbox"><img src="<?php echo e($dato['imgproduct']); ?>" class="menu-img img-fluid " alt=""></a>
                <h4><?php echo e($dato['nameproduct']); ?></h4>
                <p class="ingredients">
                <?php echo e($dato['description']); ?>

                </p>
                <p class="price">
                  $<?php echo e($dato['price']); ?>

                </p>
                <a href=" <?php echo e(route('showprt', ['id' => $dato['id']])); ?>" class="btn btn-primary btn_comprar" >COMPRAR</a>
              </div><!-- Menu Item -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Sistema_de_Ventas_Laravel\resources\views/extens/home.blade.php ENDPATH**/ ?>