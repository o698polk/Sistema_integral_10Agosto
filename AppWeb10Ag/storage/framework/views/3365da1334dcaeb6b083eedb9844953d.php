...
<meta charset="utf-8">
 ...
 <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <nav id="navbar" class="navbar">
        ...
        <a href="<?php echo e(route('trolley.index')); ?>"> <img src="../../img/cart.svg" alt=""> </a>
        </li>
          <li><a href="<?php echo e(route('home')); ?>">HOME</a></li>
          <?php if(!empty( session('user'))) {?>
          <li><a href="<?php echo e(route('dashboard')); ?>">PROFILE</a></li>
          <li><a href="<?php echo e(route('salir')); ?>">GET OUT</a></li>
          <?php } else{  ?>
...
<?php /**PATH D:\Sistema_de_Ventas_Laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>