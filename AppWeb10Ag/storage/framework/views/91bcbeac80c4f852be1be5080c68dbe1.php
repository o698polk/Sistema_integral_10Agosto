...
<?php $__env->startSection('title', 'DASHBOARD - COLEGIO 10 DE AGOSTO'); ?>
...
<div class="dashboard-container">
    <div class="dashboard-header">
        <div class="school-logo">
            <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Logo Colegio" style="width: 80px; height: 80px; filter: brightness(0) invert(1); border-radius: 100%;">
        </div>
    ...
    <div class="row">
      <div class="col-lg-4">
            <div class="profile-card">
                <img src="<?php echo e($user->imgprofile ?? 'img/default-avatar.png'); ?>" alt="avatar" class="profile-avatar">
                <h3 class="profile-name"><?php echo e($user->usuario); ?></h3>
                <p class="profile-role"><?php echo e($user->nombre_apellido); ?></p>
                
                <div class="profile-info">
                    <div class="info-item">
                        <span class="info-label"><i class="fas fa-envelope"></i> Email:</span>
                        <span class="info-value"><?php echo e($user->correo); ?></span>
            </div>
                    <div class="info-item">
                        <span class="info-label"><i class="fas fa-id-card"></i> Cédula:</span>
                        <span class="info-value"><?php echo e($user->dni); ?></span>
          </div>
                    <div class="info-item">
                        <span class="info-label"><i class="fas fa-phone"></i> Teléfono:</span>
                        <span class="info-value"><?php echo e($user->phones); ?></span>
        </div>
                    <div class="info-item">
                ...
                <div class="action-buttons">
                    <a href="<?php echo e(route('asistencias.index')); ?>" class="btn-action">
                        <i class="fas fa-clipboard-check"></i> Asistencias
                    </a>
                    <a href="<?php echo e(route('estudiantes.index')); ?>" class="btn-action">
        ...
        <div class="col-lg-8">
            ...
            <div class="admin-section">
                ...
                <div class="admin-links">
                    <a href="<?php echo e(route('usuarios.index')); ?>" class="admin-link">
                        <i class="fas fa-users-cog"></i>
                        <h4>Gestionar Usuarios</h4>
                        <p>Administrar usuarios del sistema</p>
                    </a>
                    <a href="<?php echo e(route('estudiantes.index')); ?>" class="admin-link">
                        <i class="fas fa-user-graduate"></i>
                        <h4>Gestionar Estudiantes</h4>
                        <p>Registrar y administrar estudiantes</p>
                    </a>
                    <a href="<?php echo e(route('cursos.index')); ?>" class="admin-link">
                        <i class="fas fa-book"></i>
                        <h4>Gestionar Cursos</h4>
                        <p>Administrar cursos y materias</p>
                    </a>
                    <a href="<?php echo e(route('asistencias.index')); ?>" class="admin-link">
    ...
    <?php echo method_field('PUT'); ?>
        ...
        <div class="form-group">
                                ...
                                <input type="text" name="nombre_apellido" id="nombre_apellido" 
                                       class="form-control" value="<?php echo e($user->nombre_apellido); ?>">
                            </div>
        </div>
                        <div class="col-md-6">
        <div class="form-group">
                                ...
                                <input type="text" name="usuario" id="usuario" 
                                       class="form-control" value="<?php echo e($user->usuario); ?>">
                            </div>
                        </div>
        </div>
        ...
        <div class="form-group">
                                ...
                                <input type="text" name="dni" id="dni" 
                                       class="form-control" value="<?php echo e($user->dni); ?>" maxlength="10">
                            </div>
                        </div>
        </div>
        ...
        <div class="form-group">
                                ...
                                <input type="text" name="phones" id="phones" 
                                       class="form-control" value="<?php echo e($user->phones); ?>" maxlength="10">
                            </div>
        </div>
                        <div class="col-md-6">
        <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Isate_proyect\Proyectos_practicas_studiantes\Sistema_asistencia\resources\views/extens/dashboard.blade.php ENDPATH**/ ?>