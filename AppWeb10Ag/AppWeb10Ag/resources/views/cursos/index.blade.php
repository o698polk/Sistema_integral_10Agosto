        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <form method="POST" action="{{ route('buscarcursos') }}" class="row g-3">
                            @csrf
                            <div class="col-md-4">
            ...
            <div class="col-md-3">
                <div class="card bg-primary text-white border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h4 class="card-title">{{ $datos->total() }}</h4>
            ...
            <div class="col-md-3">
                <div class="card bg-info text-white border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h4 class="card-title">{{ $datos->whereNotNull('usuario')->count() }}</h4>
            ...
            <div class="col-md-3">
                <div class="card bg-warning text-white border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h4 class="card-title">{{ $datos->whereNull('usuario')->count() }}</h4>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-primary">{{ $dato->codigo_curso }}</span>
                                </td>
                                <td>
                                    <div class="fw-bold">{{ $dato->nombre_curso }}</div>
                                    <small class="text-muted">{{ $dato->descripcion ?: 'Sin descripción' }}</small>
                                </td>
                                <td>
                                    @if($dato->descripcion)
                                        <span class="text-truncate d-inline-block" style="max-width: 150px;" title="{{ $dato->descripcion }}">
                                            {{ $dato->descripcion }}
                                        </span>
                                    @else
                                ...
                                <td class="text-center">
                                    <span class="badge bg-info">{{ $dato->capacidad_maxima }} estudiantes</span>
                                </td>
                                <td>
                                    <span class="badge bg-light text-dark">{{ $dato->aula }}</span>
                                </td>
                                <td>
                                    <div class="small">
                                        <i class="fas fa-clock me-1"></i>{{ $dato->hora_inicio }}
                                    </div>
                                    <div class="small">
                                        <i class="fas fa-clock me-1"></i>{{ $dato->hora_fin }}
                                    </div>
                                </td>
                                <td>
                                    <span class="badge bg-success">{{ $dato->dias_clase }}</span>
                                </td>
                                <td>
                                    @if($dato->usuario)
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span>{{ $dato->usuario->nombre_apellido }}</span>
                                        </div>
                                    @else
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('cursos.show', $dato->id) }}" 
                                           class="btn btn-outline-info btn-sm" 
                                           title="Ver detalles">
                                            <i class="bi bi-eye-fill"></i>
                                        </a>
                                        <a href="{{ route('cursos.edit', $dato->id) }}" 
                                           class="btn btn-outline-warning btn-sm" 
                                           title="Editar curso">
                                            <i class="bi bi-pencil-square"></i>
                                        </a>
                                        <form class="d-inline deleteForm" 
                                              action="{{ route('cursos.destroy', $dato->id) }}" 
                                              method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" 
