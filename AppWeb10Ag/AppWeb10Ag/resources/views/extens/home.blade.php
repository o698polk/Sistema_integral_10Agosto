...
@section('title', 'SISTEMA DE ASISTENCIA - COLEGIO 10 DE AGOSTO')
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="stat-card">
                    ...
                    <div class="stat-number">{{ $datos['estudiantes'] ?? 0 }}</div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stat-card">
                    ...
                    <div class="stat-number">{{ $datos['usuarios'] ?? 0 }}</div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stat-card">
                    ...
                    <div class="stat-number">{{ $datos['cursos'] ?? 0 }}</div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stat-card">
                    ...
                    <div class="stat-number">{{ $datos['asistencias'] ?? 0 }}</div>
